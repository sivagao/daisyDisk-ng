...
angular.module('visServices', [])
    .factory('visHelper', ['$rootScope',
        function($rootScope) {
            var result = {};
            var details = []; //save as json file
            return {
                scan: function(inputPath) {
                    /* reset result */
                    result = {};
                    details = [];
                    var options = {
                    ...
                    filewalker(inputPath, options)
                        ...
                        .on('done', function() {
                            ...
                            // createChart1(root);
                            $rootScope.$broadcast('data:sunBusrtView', root);
                            return;
                            var filetypeJSON = [];
                            for (var x in result) {
                ...
                getDirTableInfo: function() {

                },
                getDirSunBustrInfo: function() {
